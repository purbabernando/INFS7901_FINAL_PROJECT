...
<div class="container" >  
  	<br /><br /><br />  
   	...
   	<form method="post" action="<?php echo base_url()?>Hh_spending_controller/form_validation">  
    	<?php  
      	if($this->uri->segment(2) == "inserted")  
      	{  
           //base url - http://s4488771.uqcloud.net/tutorial/codeigniter  
           //redirect url - http://s4488771.uqcloud.net/tutorial/codeigniter/Hh_spending_controller/inserted  
                //Hh_spending_controller - segment(1)  
                //inserted - segment(2)  
  	...
  	<br /><br />  
  	<h3 align="center">HOUSEHOLD SPENDING TABLE</h3><br />  
     	...
     	?>  
      		<tr>  
            	...
            	<td><a href="#" class="delete_data" id="<?php echo $row->family_id; ?>">Delete</a></td>  
               	<td><a href="<?php echo base_url(); ?>Hh_spending_controller/update_data/<?php echo $row->family_id; ?>">Edit</a></td>  
           	</tr>  
      	<?php       
           	}  
       	}  
   	...
   	$(document).ready(function(){  
     	$('.delete_data').click(function(){  
          	var id = $(this).attr("id"); 
           	...
           	{  
            	window.location="<?php echo base_url(); ?>Hh_spending_controller/delete_data/"+id;  
         	}  
           	else  
           	{  
            	return false;  
