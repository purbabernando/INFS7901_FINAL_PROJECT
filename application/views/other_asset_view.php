...
<div class="container" >  
  	<br /><br /><br />  
   	...
   	<form method="post" action="<?php echo base_url()?>Other_asset_controller/form_validation">  
    	<?php  
      	if($this->uri->segment(2) == "inserted")  
      	{  
           //base url - http://s4488771.uqcloud.net/tutorial/codeigniter  
           //redirect url - http://s4488771.uqcloud.net/tutorial/codeigniter/Other_asset_controller/inserted  
                //Other_asset_controller - segment(1)  
                //inserted - segment(2)  
     	...
     	<div class="form-group">  
      	...
      	<div class="form-group">  
         	<label>Enter Asset Cardinality</label>  
          	<input type="text" name="asset_cardinality" value="<?php echo $row->asset_cardinality; ?>" class="form-control" />  
         	<span class="text-danger"><?php echo form_error("asset_cardinality"); ?></span>  
       	</div>  
     	<div class="form-group">  
     	...
     	<div class="form-group">  
        	<label>Enter Asset Cardinality</label>  
         	<input type="text" name="asset_cardinality" class="form-control" />  
           	<span class="text-danger"><?php echo form_error("asset_cardinality"); ?></span>  
    	</div>  
       	<div class="form-group">  
  	...
  	<br /><br />  
  	<h3 align="center">OTHER ASSETS TABLE</h3><br />  
  	<div class="table-responsive">  
     	...
     	?>  
      		<tr>  
            	...
            	<td><?php echo $row->asset_cardinality; ?></td>  
            	<td><a href="#" class="delete_data" id="<?php echo $row->asset_id; ?>">Delete</a></td>  
               	<td><a href="<?php echo base_url(); ?>Other_asset_controller/update_data/<?php echo $row->asset_id; ?>">Edit</a></td>  
           	</tr>  
      	<?php       
           	}  
       	}  
   	...
   	$(document).ready(function(){  
     	$('.delete_data').click(function(){  
          	var id = $(this).attr("id");  
           	...
           	{  
            	window.location="<?php echo base_url(); ?>Other_asset_controller/delete_data/"+id;  
         	}  
           	else  
           	{  
            	return false;  
