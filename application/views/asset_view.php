...
<div class="container" >  
  	<br /><br /><br />  
   	...
   	<form method="post" action="<?php echo base_url()?>Asset_controller/form_validation">  
    	<?php  
      	if($this->uri->segment(2) == "inserted")  
      	{  
           //base url - http://s4488771.uqcloud.net/tutorial/codeigniter  
           //redirect url - http://s4488771.uqcloud.net/tutorial/codeigniter/Asset_controller/inserted  
                //Asset_controller - segment(1)  
                //inserted - segment(2)  
  	...
  	<br /><br />  
  	<h3 align="center">FAMILY ASSET TABLE</h3><br />  
     	...
     	?>  
      		<tr>  
            	...
            	<td><a href="#" class="delete_data" id="<?php echo $row->asset_id; ?>">Delete</a></td>  
               	<td><a href="<?php echo base_url(); ?>Asset_controller/update_data/<?php echo $row->asset_id; ?>">Edit</a></td>  
           	</tr>  
      	<?php       
           	}  
       	}  
   	...
   	$(document).ready(function(){  
     	$('.delete_data').click(function(){  
          	var id = $(this).attr("id");  
           	...
           	{  
            	window.location="<?php echo base_url(); ?>Asset_controller/delete_data/"+id;  
         	}  
           	else  
           	{  
            	return false;  
