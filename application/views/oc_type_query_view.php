...
<div class="container" >  
	...
	<div id="body">
		...
		<code>
			SELECT B.type, sum(A.area) as Total_Farm_Area, sum(A.production) as Total_Farm_Production, sum(B.amount) as Total_Operational_Cost
  	...
  	<div class="table-responsive">  
     	...
     	?>  
      		<tr>  
          		...
          		<td><?php echo $row->Total_Operational_Cost; ?></td>
