...
<div class="container" >  
	...
	<div id="body">
		...
		<p>With this query, the government will be able to query the balance of family bank account</p>
		
		<code>
			SELECT SUM/AVG/MAX/MIN(bank_balance) AS Bank_Balance
		</code>
		<code>
			FROM bank_account
		</code>
    ...
    <input type="submit" value="Fetch">
  	...
  	<div align="center">
  		<a href="#" class="delete_data" >Average</a></td>
  	</div>
  	
  	<h3 align="center">BANK ACCOUNT</h3><br />  
  	<div class="table-responsive">  
     	<table class="table table-bordered">  
          	<tr>  
            	<th>Bank Balance (Rp)</th>  
