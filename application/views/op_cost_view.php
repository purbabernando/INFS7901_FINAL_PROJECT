...
<div class="navbar" align="center">
	...
	<a href="https://s4488771.uqcloud.net/">Family Asset|</a>
...
<div class="container" >  
  	<br /><br /><br />  
   	...
   	<form method="post" action="<?php echo base_url()?>Op_cost_controller/form_validation">  
    	<?php  
     	...
     	?>  
      		<tr>  
            	...
            	<td><a href="#" class="delete_data" id="<?php echo $row->longitude; ?>">Delete</a></td>  
               	<td><a href="<?php echo base_url(); ?>Op_cost_controller/update_data/<?php echo $row->longitude; ?>">Edit</a></td>  
           	</tr>  
      	<?php       
           	}  
       	}  
   	...
   	$(document).ready(function(){  
     	$('.delete_data').click(function(){  
          	var id = $(this).attr("id");  
           	...
           	{  
            	window.location="<?php echo base_url(); ?>Op_cost_controller/delete_data/"+id;  
         	}  
           	else  
           	{  
            	return false;  
